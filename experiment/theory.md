...
Where, D<sub>m</sub> is the measured diameter and t is sample thickness. The sample thickness of TEM foil is assumed approximately 70 - 80 nm. The true sample thickness can be measured using electron energy loss spectroscopy (EELS), where integral over the zero-loss peak (I<sub>0</sub>) and entire peak (I<sub>t</sub>) used to determine the TEM sample thickness.
<br>
